...
<body>
 ...
 <div class="container">
    <form class="form-horizontal" role="form" action="${pageContext.servletContext.contextPath}/useradd" method="post">
       ...
       <div id = "reg"> <h2>Registration Form</h2> </div>
        ...
        <div class="form-group">
            ...
            <div class="col-sm-9">
                <input type="text" id="lastname" placeholder="Full Name" class="form-control" name="lastname" autofocus>
            </div>
        </div>
